    ...
    <div class="form-grid-tabs">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
                <button class="btn nav-link active" id="home-tab" data-bs-toggle="tab"
                    ...
                    aria-selected="true">Applied jobs</button>
            </li>
            <li class="nav-item" role="presentation">
                <button class="btn nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#application-sent"
                    type="button" role="tab" aria-controls="application-sent" aria-selected="false">Posted jobs</button>
            </li>
        </ul>
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="interview-schedule" role="tabpanel" aria-labelledby="home-tab">
                ...
                <!--Section-table-->
                <div class="company-interview-schedule table table-tabs">
                        ...
                        <table>
                            <thead>
                                <tr class="table-light row100 head">
                                    ...
                                    <th class="cell100 column2">Posted Date</th>
                                    <th class="cell100 column3">Close Date</th>
                                    <th class="cell100 column4">Candidate</th>
                            ...
                            <tbody>
                                <tr class="table-light row100 body">
                                    ...
                                    <td class="cell100 column3">Dec 21th 2020</td>
                                    <td class="cell100 column4">
                                        <div class="name-img">
                                            <figure class="me-2"><img src="images/placeholder.png" alt="img"> </figure>
                                            Adrian Thomos
                                        </div>
                                    </td>
                                    <td class="cell100 column5">UI Designer</td>
                                    <td class="cell100 column6"><a class="btn btn-pending" href="#">Pending</a></td>
                                    <td class="cell100 column7"><a class="btn btn-view" href="#">View</a> <a
                                            class="btn btn-hold ms-3" href="#">Delete</a></td>
                                </tr>
                                <tr class="table-light row100 body">
                                    <td class="cell100 column1">
                                ...
                                <tr class="table-light row100 body">
                                    <td class="cell100 column1">
                                        ...
                                        <div class="form-group">
                                            <input type="checkbox" id="seventh-7">
                                            <label for="seventh-7"></label>
                                        </div>
                            ...
                            <thead>
                                <tr class="table-light row100 head">
                                    <th class="cell100 column1">
                                        ...
                                        <div class="form-group">
                                            <input type="checkbox" id="first-11">
                                            <label for="first-11"></label>
                                        </div>
                            ...
                            <tbody>
                                <tr class="table-light row100 body">
                                    <td class="cell100 column1">
                                        ...
                                        <div class="form-group">
                                            <input type="checkbox" id="second-22">
                                            <label for="second-22"></label>
                                        </div>
                                ...
                                <tr class="table-light row100 body">
                                    <td class="cell100 column1">
                                        ...
                                        <div class="form-group">
                                            <input type="checkbox" id="third-33">
                                            <label for="third-33"></label>
                                        </div>
                                ...
                                <tr class="table-light row100 body">
                                    <td class="cell100 column1">
                                        ...
                                        <div class="form-group">
                                            <input type="checkbox" id="fourth-44">
                                            <label for="fourth-44"></label>
                                        </div>
                                ...
                                <tr class="table-light row100 body">
                                    <td class="cell100 column1">
                                        ...
                                        <div class="form-group">
                                            <input type="checkbox" id="fifth-55">
                                            <label for="fifth-55"></label>
                                        </div>
                                ...
                                <tr class="table-light row100 body">
                                    <td class="cell100 column1">
                                        ...
                                        <div class="form-group">
                                            <input type="checkbox" id="sixth-66">
                                            <label for="sixth-66"></label>
                                        </div>
                                ...
                                <tr class="table-light row100 body">
                                    <td class="cell100 column1">
                                        ...
                                        <div class="form-group">
                                            <input type="checkbox" id="seventh-77">
                                            <label for="seventh-77"></label>
                                        </div>
