(function($) {
    ...
    $(document).ready(function() {
        $(".sidebar li").click(function() {
            $(this).children(".drop-down").toggleClass("aa");
            $(this).siblings().children(".drop-down").removeClass("aa");
        });
    });
    ...
    jQuery('.popup__close').click(function(event) {
        jQuery(' .pop-up-thanks').removeClass('is-active');
